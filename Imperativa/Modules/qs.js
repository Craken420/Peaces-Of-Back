...
// const encodedUtfHex = new Buffer('01111D0E1F0E2B21212C2E05213C27283632253C').toString('utf8')

const decoded = new Buffer('01111D0E1F0E2B21212C2E05213C27283632253C', 'latin1').toString('latin1')
